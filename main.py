...
def optionalChallenge(planeData, distance, weights, temperatures):
    for weight in weights:
        for temperature in temperatures:
            ...
            flightTime, fuelUse = getSingleFlightTimeAndFuelUse(planeData, distance,weight,altitude_options[0],temperature)
            minTime = flightTime
            minFuel = fuelUse
            ...
            for i in range(1,len(altitude_options)):
                flightTime, fuelUse = getSingleFlightTimeAndFuelUse(planeData, distance,weight,altitude_options[i],temperature)
            ...
            print("Weigth:", weight, "lbs.; Temperature:", temperature,"celsius.\n",
                  "    Minimal flight time is", '{0:02.0f}:{1:02.0f}'.format(*divmod(minTime * 60, 60)), "hours at", minTimeAlt, "feet.\n",
                  "    Minimal fuel use is", '{0:.3f}'.format(minFuel), "lbs. at", minFuelAlt, "feet.")
    
#optionalChallenge(planeData, 1337,[3000,4000],[10,0,-10])
